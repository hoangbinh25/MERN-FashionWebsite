          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              <div className="flex-1">
                <label className="text-xs sm:text-sm font-semibold text-gray-600">Giá tiền (VNĐ)<span className="text-red-500">*</span></label>
                <input
                  type="number"
                  name="price"
                  min={0}
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs sm:text-sm font-semibold text-gray-600">Kích cỡ + số lượng</label>
